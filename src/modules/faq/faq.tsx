...
const Faq: FC<FaqProps> = ({ className }) => {
  ...
  const translations: Record<Language, { title: string; text: string; leftP: string; topP: string }[]> = {
    ru: [
      ...
      { title: 'Кто ищет офферы?', text: 'В штате компании есть опытный Bizdev, который помогает найти любой оффер и увеличить ставку по нему', leftP: '63%', topP: '8%' },
      { title: 'Кто занимается техническим сопровождением?', text: 'Опытный IT-интегратор сопровождает технический процесс запуска РК на всех этапах', leftP: '30%', topP: '45%' },
      { title: 'Кто руководит баингом?', text: 'Каждый источник имеет Head и Team Lead, координирующих команды и процессы', leftP: '61%', topP: '2%' },
